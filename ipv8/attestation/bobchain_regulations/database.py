...
class BOBChainRegulationsDB(Database):
    """
    ...
    def __init__(self, working_directory, db_name):
        ...
        super(BOBChainRegulationsDB, self).__init__(db_path)
    ...
    def open(self, initial_statements=True, prepare_visioning=True):
        return super(BOBChainRegulationsDB, self).open(initial_statements, prepare_visioning)

    def close(self, commit=True):
        return super(BOBChainRegulationsDB, self).close(commit)
